...
import vidyoatmav1.repositories.AuthenticationByNameRepo;

@Component
@RequiredArgsConstructor
public class GenerateAuthentication {

    private final AuthenticationByNameRepo authenticationByName;
    ...
    private boolean checkExist(String username) {
         ...
         */
        Optional<AuthenticationByUsername> user = authenticationByName.findByLoginName(username);
